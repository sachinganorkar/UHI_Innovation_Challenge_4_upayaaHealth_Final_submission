...
const swiper: Reducer<SwiperState, SwiperActionTypes> = (
  ...
  switch (action.type) {
    case SET_SWIPER_STATE: {
      ...
      const newSwiperState: any = action.swiperState;
              ...
              if (
                ...
                if (blockCat === "walkPath") {
                  ...
                  if (
                    ...
                    item.id !== "default_thankyou_screen"
                  ) {
                    validBlocksStructure = false;
                  }
                }
      ...
      const newCurrentBlockId = newSwiperState.currentBlockId
        ...
        : currentBlockId;
      const isFirstField =
        newWalkPath?.length > 0 && newWalkPath[0].id == newCurrentBlockId;
      ...
      return {
        ...
        isWelcomeScreenActive: !!(
          ...
          some(newWelcomeScreens, (screen) => screen.id === newCurrentBlockId)
        ),
        isThankyouScreenActive: !!(
          some(newThanksScreens, (screen) => screen.id === newCurrentBlockId) ||
          newCurrentBlockId === "default_thankyou_screen"
        ),
      };
    }
    ...
    case GO_NEXT: {
      ...
      const currentFieldIndex = walkPath.findIndex(
        (field: { id: string | undefined }) => field.id === currentBlockId
      );
      ...
      const newCurrentFieldIndex = walkPath.findIndex(
        ($field: { id: string | undefined }) => $field.id === $newCurrentBlockId
      );
      ...
      return {
        ...state,
        canSwipeNext: !!$newCurrentBlockId,
        canSwipePrev: true,
    ...
    case GO_PREV: {
      ...
      return {
        ...state,
        canSwipePrev: !!walkPath[currentFieldIndex - 2],
        canSwipeNext: true,
    ...
    case GO_TO_BLOCK: {
      ...
      return {
        ...
        currentBlockId: id,
        isAnimating: true,
        canSwipeNext: !!walkPath[fieldIndex + 1],
        canSwipePrev: !!walkPath[fieldIndex - 1],
